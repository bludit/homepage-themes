		...
		<?php foreach ($_items as $item): ?>
			...
			<div class="card h-100">
				<a href="<?php echo $item['permalink'] ?>">
					<div style="height: 400px; background: url('<?php echo $item['screenshot_url'] ?>'); background-repeat: no-repeat; background-position: top center; background-size: cover;"></div>
				</a>
				<div class="card-body">
