				...
				<div class="card-body">
					...
					<?php
						...
						if ($item['price_usd']>0) {
							...
							echo '<a class="btn btn-secondary btn-sm" href="'.$item['permalink'].'#download" role="button" target="_blank"><i class="fa fa-download" aria-hidden="true"></i> '.l('Download',false).'</a>'.PHP_EOL;
						}
					?>
				</div>
			</div>
